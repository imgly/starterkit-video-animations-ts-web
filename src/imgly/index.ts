...
const SCENES_CDN_URL =
  'https://img.ly/showcases/cesdk/cases/animations/templates';
...
export async function initVideoAnimationsEditor(cesdk: CreativeEditorSDK) {
  ...
  cesdk.ui.setDockOrder([
    ...
    ...cesdk.ui
      .getDockOrder()
      .filter(({ key }) => !['ly.img.templates'].includes(key as string))
  ]);
  ...
  await cesdk.loadFromURL(`${SCENES_CDN_URL}/lunar-cosmetics.scene`);

  // ============================================================================
  // Navigation Bar Configuration
  // ============================================================================

  // Add export video button to navigation bar (replaces deprecated config)
  cesdk.i18n.setTranslations({
    en: {
      ...cesdk.i18n.getTranslations().en,
      'actions.export.video': 'Export Video'
    }
  });
